    ...
    <div v-if="openModal" class="fixed inset-0 z-40 flex justify-center items-center bg-violet-950 bg-opacity-50">
      <div class="bg-violet-200 rounded-lg shadow-lg p-8 w-full max-w-sm text-violet-950">
      	<div class="flex justify-center">
	        <div class="flex justify-center w-36 h-36 items-center mt-4 rounded-full border-4 border-violet-300 bg-center bg-cover" :style="{ backgroundImage: 'url(' + profileImage + ')' }">
...
const profileImage = ref('favicon.ico');
