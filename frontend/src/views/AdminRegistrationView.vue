        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-auto lg:py-0">
            ...
            <div class="w-full bg-violet-950 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <form @submit.prevent="handleRegistration" class="space-y-4 md:space-y-4 text-indigo-100">
                        <div class="flex flex-row gap-4">
                            <div>
                                <label for="firstName" class="block mb-2 text-left text-sm font-medium">First Name</label>
                                <input v-model="firstName" type="text" name="firstName" id="firstName" class="bg-violet-200 text-violet-950 text-sm rounded-lg block w-full p-2.5 " placeholder="First name" required/>
                            </div>
                            <div>
                                <label for="lastName" class="block mb-2 text-left text-sm font-medium">Last Name</label>
                                <input v-model="lastName" type="text" name="lastName" id="lastName" class="bg-violet-200 text-violet-950 text-sm rounded-lg block w-full p-2.5 " placeholder="Last name" required/>
                            </div>
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-left text-sm font-medium">Email</label>
                            <input v-model="email" type="email" name="email" id="email" class="bg-violet-200 text-violet-950 text-sm rounded-lg block w-full p-2.5 " placeholder="name@company.com" autocomplete="email" @input='validateEmail' required/>
                            <p v-if="emailError" class="text-red-500 text-sm mt-2">{{ emailError }}</p> 
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-left text-sm font-medium">Password</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="confirmPassword" class="block mb-2 text-left text-sm font-medium">Confirm Password</label>
                            <div class="relative">
